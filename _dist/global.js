...
TCM.Global.sysCaller = function(name, params, cbFn, failFn){
	...
	case "copySites" :
		/**
			params: {ip}
		*/
		setTimeout(function(){cbFn(Test.copySites(params));}, 1000);
		break;
	case "affiliateSites" : 
		/**
			params: {ids: []}
		*/
		setTimeout(function(){cbFn(Test.affiliateSites(params));}, 100);
		break;
	}
};
...
TCM.Global.storeCaller = function(name, params, cbFn, failFn){
	...
	case "deletePlan" :
		...
		*/	
		...
		break;
	case "getSite4WallAndStore" :
		/*
			cbFn([{id, name}]);
		*/	
		setTimeout(function(){cbFn(Test.getSite4WallAndStore());},100);
		break;
	}
};
